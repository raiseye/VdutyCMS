...
<c:set var="menu_active" value="nav_message"/>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#" class="item-link item-content  ">
                                <div class="item-media "><span class="icon icon-message " style="font-size: 1rem; color: #0894ec;"></span></div>
                                <div class="item-inner">
                                    <div class="item-title" style="font-size:0.7rem;">我的私信</div>
                                </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="#" class="item-link item-content  ">
                                <div class="item-media "><span class="icon icon-message " style="font-size: 1rem; color: #0894ec;"></span></div>
                                <div class="item-inner">
                                    <div class="item-title" style="font-size:0.7rem;">我的任务</div>
                                </div>
                            </a>
                        </li>
