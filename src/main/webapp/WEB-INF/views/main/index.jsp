...
<body>
	...
	<div class="page-group">
		...
		data-transition="slide-out"><span class="icon icon-menu"></a></span>' />
			<c:set var="headerbar_title" value="<span>${title_name}</span>" />
			<c:set var="headerbar_right"
				value='<span class="icon icon-edit"></span>' />
				...
				<div class="page-index">
					<div class="card">
						<div
							...
							valign="bottom" class="card-header color-white no-border">板块一</div>
						<div class="card-content">
							<div class="card-content-inner">
								<p class="color-gray">发表于 2017/01/15</p>
								<p>此处是内容...</p>
							</div>
						</div>
					...
					<div class="card">
						<div
							style="background-image: url(//gqianniu.alicdn.com/bao/uploaded/i4//tfscom/i3/TB10LfcHFXXXXXKXpXXXXXXXXXX_!!0-item_pic.jpg_250x250q60.jpg)"
							valign="bottom" class="card-header color-white no-border">板块二</div>
						<div class="card-content">
							<div class="card-content-inner">
					...
					<div class="card">
						<div
							style="background-image: url(//gqianniu.alicdn.com/bao/uploaded/i4//tfscom/i3/TB10LfcHFXXXXXKXpXXXXXXXXXX_!!0-item_pic.jpg_250x250q60.jpg)"
							valign="bottom" class="card-header color-white no-border">板块三</div>
						<div class="card-content">
							<div class="card-content-inner">
								<p class="color-gray">发表于 2015/01/15</p>
								<p>此处是内容...</p>
